...
# Load datasets
pitch_df = pd.read_csv("C:\\Users\\franc\\OneDrive\\Hawks25\\NECBL_2024_Pitches.csv", low_memory=False)
batting_df = pd.read_csv("C:\\Users\\franc\\OneDrive\\Hawks25\\necbl_combined_batting_stats.csv", low_memory=False)
